...
<!--<div class="bar">export || <a href="/config/changelog/<?php echo $config_id; ?>">changelog</a> || update || send notifications</div>-->
<?php
echo Form::open('/config/update/'.$config_id, $attributes)."\n";
?>
